        ...
        <div className="d-flex align-items-center">
          ...
          <div className="actions">
            ...
            <a href="#"
               ...
               onClick={this.handleToggleStatus.bind(this, tvshow, userStatus?.currentStatus == SeenStatus.toSee ? SeenStatus.unknown : SeenStatus.toSee)}
               title="A voir"
            >
            ...
            <Dropdown className="d-inline-block">
              ...
              <Dropdown.Menu align="end">
                ...
                <Dropdown.Item onClick={this.handleToggleAllStatus.bind(this, this.state.tabSeason, SeenStatus.toSee)}>Marquer la saison comme non vue</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </div>
        </div>
